 ...
 *              Inagan Pincho Alexander
 */

//Simula los clientes que se manipulan desde una base de datos.
//Es el Observable
public class ClientesDB extends java.util.Observable{
    ...
    private void inicializarDatos() {
        //Inicializa el arrayList de Clientes
        clientes = new ArrayList();
        
        //Agrega clientes al arrayList de Clientes
    ...
    */
    ...
    public ArrayList<Cliente> getClientesPorProfesion() {
        return this.clientesPorProfesion;
    }
